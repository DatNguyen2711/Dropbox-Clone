      ...
      {({
        ...
        return (
          <section className="m-4">
            <div
              className={cn(
                "w-full h-52 flex justify-center mt-5 backdrop-brightness-75 items-center p-5 border-2 border-dashed rounded-md",
                isDragActive
            ...
            >
              ...
              {!isDragReject && isDragActive && "Drop to upload this file !"}
